...
namespace MusicApplication.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "Hasło i jego potwierdzenie nie są takie same.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, Roles.Podstawowa.ToString());
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        $"Proszę potwierdź swój email przez <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>kliknięcie tutaj</a>.");
