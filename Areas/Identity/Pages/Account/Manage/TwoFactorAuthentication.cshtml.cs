...
namespace MusicApplication.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            StatusMessage = "Obecna przeglądarka została zapomniana. Gdy będziesz ponownie logował się przy użyciu tej przęglądarki zostaniesz poproszony o kod uwierzytelniający.";
